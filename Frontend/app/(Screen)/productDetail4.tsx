...
const ProductDetailScreen = () => {
  ...
  return (
    <ScrollView className="flex-1 bg-[#f9f9f9] px-4 pt-14">
      ...
      {/* Product Image */}
      <Image
        source={require("../../assets/images/3.png.png")}  // Use getIconUri to fetch the correct image based on type (flavour in this case)
      ...
      <View className="flex-row justify-between items-center px-1 mb-2">
        <Text className="text-xl font-bold text-gray-800">Choco Swirl Dream</Text>
        <Text className="text-lg font-semibold text-gray-600">130</Text>
      </View>
      <Text className="text-left text-gray-500 mb-4 px-1">Classic vanilla soft-serve drenched in velvety chocolate sauce. Smooth and satisfying in every</Text>
