...
const ProductDetailScreen = () => {
  ...
  return (
    <ScrollView className="flex-1 bg-[#f9f9f9] px-4 pt-14">
      ...
      {/* Product Image */}
      <Image
        source={require("../../assets/images/2.png.png")}  // Use getIconUri to fetch the correct image based on type (flavour in this case)
      ...
      <View className="flex-row justify-between items-center px-1 mb-2">
        <Text className="text-xl font-bold text-gray-800">Rainbow Surprise</Text>
        <Text className="text-lg font-semibold text-gray-600">150</Text>
      </View>
      <Text className="text-left text-gray-500 mb-4 px-1">A colorful mix of magical flavors — sweet, happy, and full of fun in every bite.</Text>
